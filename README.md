# Predict Personality Through Resume Analysis
This repository demonstrates the implementation of 'Predicting Personality through Resume Analysis' using Python. Explore machine learning methodologies applied to resume data to forecast diverse personality traits. Gain insights into the relationship between demographic features and personality types for comprehensive predictive analysis.

## Table of Contents
- [Objectives](#objectives)
- [Background of Personality Perception](#background-of-personality-perception)
- [Dependencies of System](#dependencies-of-system)
...
## Screenshots
### Landing Page
![App Screenshot](https://drive.google.com/uc?id=1nJ-_F2PSMeAc-GVd44SLUzwg9sUOduPi)

### Upload Resume with Details
![App Screenshot](https://drive.google.com/uc?id=1xR3PM6CK2F8rOes0Or1tvmn9A4MmidMQ)

### Result Page
![App Screenshot](https://drive.google.com/uc?id=1I87MtV2erPeI6bt7GQIjOjBWxPf091vN)

### Command Line Output
![App Screenshot](https://drive.google.com/uc?id=1RKyjZKejOk86YOCp7SPSuifsBRKynTYk)
